<template>
  <router-link
    ...
    class="group bg-white/80 backdrop-blur-xl rounded-2xl overflow-hidden shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] transition-all duration-500 ease-out hover:-translate-y-2 focus:outline-none focus:ring-2 focus:ring-emerald-500/30 flex flex-col h-full relative border border-gray-100/20"
  >
    <!-- Görsel alanı -->
    <div
      class="relative aspect-[3/4] overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 w-full"
    >
      <img
    ...
    <!-- İçerik alanı -->
    <div
      class="pt-3 px-4 pb-3 flex flex-col flex-grow bg-gradient-to-b from-white/50 to-white min-h-0"
    >
