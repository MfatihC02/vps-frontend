<template>
  <div class="max-w-2xl mx-auto space-y-8">
    ...
    <!-- Ürün Açıklaması -->
    <div v-if="description" class="bg-white p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-sm border border-gray-100">
      <div class="prose prose-sm sm:prose-base max-w-none font-inter text-gray-700" v-html="description"></div>
    </div>
