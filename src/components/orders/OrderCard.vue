<!-- OrderCard.vue -->
<template>
  <div class="order-card bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-300 p-4">
    ...
    <div class="space-y-4 mb-4">
      <div v-for="item in order.items" :key="item._id" class="flex gap-4 items-center">
        <div class="flex-1">
          ...
          <div class="flex items-center gap-1 text-sm text-gray-500 mt-1">
            <component :is="getProductTypeIcon(item.product.productType)" class="w-4 h-4" />
