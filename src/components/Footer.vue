<template>
  <footer class="bg-gray-900 text-gray-300">
    ...
    <div class="container mx-auto px-4 py-12">
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div class="space-y-4">
          ...
          <ul class="space-y-2">
            <li>
              <router-link to="/hakkimizda" class="hover:text-green-500 transition-colors duration-200 flex items-center">
                <iconify-icon icon="mdi:chevron-right" style="color: #34C759;" width="16"></iconify-icon>
                Hakkımızda
              </router-link>
            </li>
            <li>
              <router-link to="/iletisim" class="hover:text-green-500 transition-colors duration-200 flex items-center">
                <iconify-icon icon="mdi:chevron-right" style="color: #34C759;" width="16"></iconify-icon>
                İletişim
              </router-link>
            </li>
            <li>
              <router-link to="/career" class="hover:text-green-500 transition-colors duration-200 flex items-center">
                <iconify-icon icon="mdi:chevron-right" style="color: #34C759;" width="16"></iconify-icon>
                Kariyer
              </router-link>
            </li>
            <li>
              <router-link to="/blog" class="hover:text-green-500 transition-colors duration-200 flex items-center">
                <iconify-icon icon="mdi:chevron-right" style="color: #34C759;" width="16"></iconify-icon>
                Blog
              </router-link>
            </li>
        ...
        <!-- Müşteri Hizmetleri -->
        <div class="space-y-4">
          <h3 class="text-lg font-semibold text-white mb-4">Müşteri Hizmetleri</h3>
          <ul class="space-y-2">
            <li>
              <router-link to="/faq" class="hover:text-green-500 transition-colors duration-200 flex items-center">
                <iconify-icon icon="mdi:chevron-right" style="color: #34C759;" width="16"></iconify-icon>
                Sıkça Sorulan Sorular
              </router-link>
            </li>
            <li>
              <router-link to="/returns" class="hover:text-green-500 transition-colors duration-200 flex items-center">
                <iconify-icon icon="mdi:chevron-right" style="color: #34C759;" width="16"></iconify-icon>
                İade ve Değişim
              </router-link>
            </li>
            <li>
              <router-link to="/shipping" class="hover:text-green-500 transition-colors duration-200 flex items-center">
                <iconify-icon icon="mdi:chevron-right" style="color: #34C759;" width="16"></iconify-icon>
                Kargo Bilgileri
              </router-link>
            </li>
        ...
        <!-- İletişim Bilgileri -->
        <div class="space-y-4">
          <h3 class="text-lg font-semibold text-white mb-4">İletişim Bilgileri</h3>
          <ul class="space-y-3">
            <li class="flex items-start space-x-3">
              <iconify-icon icon="mdi:map-marker" style="color: #34C759;" width="20"></iconify-icon>
              <span>Şükran Mah. Sahibi Ata Cad. No:38 Meram, Konya</span>
            </li>
            <li>
              <a href="tel:03323513128" class="flex items-center space-x-3 hover:text-green-500 transition-colors duration-200">
                <iconify-icon icon="mdi:phone" style="color: #34C759;" width="20"></iconify-icon>
                <span>0332 351 31 28</span>
              </a>
            </li>
            <li>
              <a href="mailto:muhendislerticaretyeni@gmail.com" class="flex items-center space-x-3 hover:text-green-500 transition-colors duration-200">
                <iconify-icon icon="mdi:email" style="color: #34C759;" width="20"></iconify-icon>
                <span>muhendislerticaretyeni@gmail.com</span>
              </a>
            </li>
            <li class="flex items-start space-x-3">
              <iconify-icon icon="mdi:clock" style="color: #34C759;" width="20"></iconify-icon>
              <div>
        ...
        <div class="space-y-6">
          <div>
            ...
            <div class="flex space-x-4">
              <a href="https://www.instagram.com/muhendislerticaretkonya/" class="transform hover:scale-110 transition-transform duration-200">
                <iconify-icon icon="mdi:instagram" style="color: #E4405F;" width="24"></iconify-icon>
              </a>
              <a href="#" class="transform hover:scale-110 transition-transform duration-200">
                <iconify-icon icon="mdi:linkedin" style="color: #0A66C2;" width="24"></iconify-icon>
              </a>
              <a href="#" class="transform hover:scale-110 transition-transform duration-200">
                <iconify-icon icon="mdi:youtube" style="color: #FF0000;" width="24"></iconify-icon>
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <form @submit.prevent="subscribeNewsletter" class="space-y-3">
              <div class="relative">
                ...
                >
                  <iconify-icon icon="mdi:send" style="color: #34C759;" width="20" v-if="!isSubscribing"></iconify-icon>
                  <iconify-icon icon="mdi:loading" style="color: #34C759;" width="20" v-else></iconify-icon>
                </button>
              </div>
            </form>
          </div>
            ...
            <div class="container mx-auto">
              <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                ...
                <div class="flex items-center space-x-2 text-sm text-gray-400"> <br>
                  ...
                  <a href="https://www.linkedin.com/in/fatih-%C3%A7a%C4%9F%C4%B1rgan-151b892a5/" target="_blank" rel="noopener noreferrer" 
    ...
    >
      <iconify-icon icon="mdi:arrow-up" style="color: white;" width="24"></iconify-icon>
    </button>
  </footer>
</template>
