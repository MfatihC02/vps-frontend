      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 min-h-[300px]">
        ...
        <div class="space-y-4">
          ...
          <ul class="space-y-2">
            ...
            <li>
              <router-link :to="{ name: 'return-policy' }" class="hover:text-green-500 transition-colors duration-200 flex items-center">
                <iconify-icon icon="mdi:chevron-right" style="color: #34C759;" width="16"></iconify-icon>
                İade ve Değişim Politikası
              </router-link>
            </li>
            <li>
              <router-link :to="{ name: 'privacy-policy' }" class="hover:text-green-500 transition-colors duration-200 flex items-center">
                <iconify-icon icon="mdi:chevron-right" style="color: #34C759;" width="16"></iconify-icon>
                Gizlilik Politikası
              </router-link>
            </li>
