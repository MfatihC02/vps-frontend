<template>
  <footer
    class="bg-gray-900 text-gray-300 h-[600px] md:h-[500px] w-full flex flex-col"
  >
    <!-- Üst Footer -->
    <div class="container mx-auto px-4 py-8 flex-1">
      <div
        class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 flex-grow"
      >
        <!-- Kurumsal -->
        <div class="space-y-4">
          <button
          ...
          <ul
            :class="{ 'hidden sm:block': !sections.kurumsal }"
            class="space-y-2"
          >
            <li>
              <router-link
        ...
        <div class="space-y-4">
          ...
          <ul
            :class="{ 'hidden sm:block': !sections.musteri }"
            class="space-y-2"
          >
            <li>
              <router-link
        ...
        <div class="space-y-4">
          ...
          <ul
            :class="{ 'hidden sm:block': !sections.iletisim }"
            class="space-y-3"
          >
            <li class="flex items-start space-x-3">
              ...
              ></iconify-icon>
              <span>
                MUSALLA BAĞLARI MAH, Yeni İstanbul Cd. NO:8 Selçuklu,
                Konya</span
              >
            </li>
            <li>
        ...
        <div class="block w-full">
          ...
          >
            ...
            <span class="font-semibold text-base" style="contain: content"
              >WhatsApp'tan Sipariş Ver</span
            >
          </a>
        </div>
      </div>
        ...
        <div class="border-t border-gray-700 pt-4 mt-2">
          ...
          >
            <div class="text-sm text-gray-400">
              &copy; {{ new Date().getFullYear() }} TARİMSEPETİM - Mühendisler
              Ticaret Kollektif Şirketi'nin tescilli markasıdır. Tüm hakları
              saklıdır.
            </div>
