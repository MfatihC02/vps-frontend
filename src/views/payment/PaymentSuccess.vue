    ...
    <div class="max-w-md w-full bg-white rounded-xl shadow-lg overflow-hidden">
      ...
      <div v-else class="p-8">
        ...
        <div class="flex flex-col sm:flex-row gap-3">
          <router-link to="/dashboard/orders" class="flex-1 inline-flex justify-center items-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-primary hover:bg-primary-dark focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
            Siparişlerime Git
          </router-link>
          <router-link to="/siparislerim" class="flex-1 inline-flex justify-center items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
            Alışverişe Devam Et
          </router-link>
        </div>
      </div>
