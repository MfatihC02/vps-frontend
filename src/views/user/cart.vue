            ...
            >
              <div class="max-w-md mx-auto">
                ...
                <p class="text-gray-600 mb-8">
                  Sepetinizde henüz ürün bulunmamaktadır. Ürünlerimizi
                  inceleyerek alışverişe başlayabilirsiniz.
                </p>
                <button
                  @click="$router.push('/products')"
              ...
              <div class="mt-6 space-y-4">
                <div class="flex items-center justify-between">
                  ...
                  <p class="text-sm font-medium text-gray-900">
                    ₺{{
                      formatPrice(
                        cartStore.cart?.totalAmount || cartStore.subtotal || 0
                      )
                    }}
                  </p>
                </div>
                ...
                <!-- İndirimli ara toplam (eğer kupon uygulanmışsa) -->
                <div
                ...
                <div class="border-t border-gray-200 pt-4">
                  <div class="flex items-center justify-between">
                    ...
                    <p class="text-base font-medium text-gray-900">
                      ₺{{
                        formatPrice(
                          cartStore.cart?.discountedTotalAmount
                            ? cartStore.cart.discountedTotalAmount +
                                (cartStore.shipping || 200)
                            : cartStore.cart?.totalAmount
                            ? cartStore.cart.totalAmount +
                              (cartStore.shipping || 200)
                            : cartStore.grandTotal || cartStore.finalTotal || 0
                        )
                      }}
                    </p>
                  </div>
